 ...
 */
public class recycleviewfraggrid extends Fragment{

    private RecyclerView rec;
    private RecyclerViewAdapterGrid recyclerViewAdapter;
    ...
    public recycleviewfraggrid() {
        // Required empty public constructor
    }

    public static recycleviewfraggrid newInstance(){
        recycleviewfraggrid myfragment = new recycleviewfraggrid();
        return myfragment;
    }
    ...
    public View onCreateView(final LayoutInflater inflater, ViewGroup container,
        ...
        recyclerViewAdapter = new RecyclerViewAdapterGrid(getActivity(), movieData);
        rec.setAdapter(recyclerViewAdapter);

        recyclerViewAdapter.registerListener(new RecyclerViewAdapterGrid.OnItemViewSelected() {
